...
module tb_vector_vmem #(parameter integer MODE=0);
  ...
  rv32_vec_vadd_engine #(.LATENCY(3)) engine(.clk,.rst_n,.vec_cmd_valid(vec_cmd_valid&&allow_cmd),.vec_cmd_ready(eng_cmd_ready),.vec_cmd_op_class,.vec_cmd_funct,.vec_cmd_vs1,.vec_cmd_vs2,.vec_cmd_vd,.vec_cmd_rs1_data,.vec_cmd_imm,.vec_cmd_id,.vec_cpl_ready(eng_cpl_ready),.vec_cpl_valid(eng_cpl_valid),.vec_cpl_id,.vec_cpl_status,.vec_cpl_result_valid,.vec_cpl_result_data,.vec_cpl_exception_cause,.busy(),.dbg_we,.dbg_waddr,.dbg_wdata,.dbg_raddr,.dbg_rdata,.dbg_vreg_write_valid,.dbg_vreg_write_addr,.dbg_vreg_write_data,.dbg_spad_we,.dbg_spad_addr,.dbg_spad_wdata,.dbg_spad_raddr,.dbg_spad_rdata,.dbg_spad_write_valid,.dbg_spad_write_addr,.dbg_spad_write_data);
